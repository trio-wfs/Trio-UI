...
const DS_NAV = {
  ...
  mui: [
    ...
    { label: 'Avatar',        icon: 'account_circle',         href: 'components/Avatar/avatar-showcase.html' },
    ...
    { label: 'Card',          icon: 'view_agenda',            href: 'components/Card/card-showcase.html' },
    ...
    { label: 'Paper',           icon: 'layers',                 href: 'components/Paper/paper-showcase.html' },
