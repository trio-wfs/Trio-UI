...
`,B=o(`span`,{name:`MuiTouchRipple`,slot:`Root`})({overflow:`hidden`,pointerEvents:`none`,position:`absolute`,zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:`inherit`}),V=o(P,{name:`MuiTouchRipple`,slot:`Ripple`})`
  opacity: 0;
  position: absolute;
...
`,ne=b.forwardRef(function(e,t){let{center:n=!1,classes:r={},className:i,...a}=c({props:e,name:`MuiTouchRipple`}),[o,s]=b.useState([]),l=b.useRef(0),d=b.useRef(null);b.useEffect(()=>{d.current&&=(d.current(),null)},[o]);let f=b.useRef(!1),p=m(),h=b.useRef(null),g=b.useRef(null),_=b.useCallback(e=>{let{pulsate:t,rippleX:n,rippleY:i,rippleSize:a,cb:o}=e;s(e=>[...e,(0,N.jsx)(V,{classes:{ripple:u(r.ripple,F.ripple),rippleVisible:u(r.rippleVisible,F.rippleVisible),ripplePulsate:u(r.ripplePulsate,F.ripplePulsate),child:u(r.child,F.child),childLeaving:u(r.childLeaving,F.childLeaving),childPulsate:u(r.childPulsate,F.childPulsate)},timeout:I,pulsate:t,rippleX:n,rippleY:i,rippleSize:a},l.current)]),l.current+=1,d.current=o},[r]),v=b.useCallback((e={},t={},r=()=>{})=>{let{pulsate:i=!1,center:a=n||t.pulsate,fakeElement:o=!1}=t;if(e?.type===`mousedown`&&f.current){f.current=!1;return}e?.type===`touchstart`&&(f.current=!0);let s=o?null:g.current,c=s?s.getBoundingClientRect():{width:0,height:0,left:0,top:0},l,u,d;if(a||e===void 0||e.clientX===0&&e.clientY===0||!e.clientX&&!e.touches)l=Math.round(c.width/2),u=Math.round(c.height/2);else{let{clientX:t,clientY:n}=e.touches&&e.touches.length>0?e.touches[0]:e;l=Math.round(t-c.left),u=Math.round(n-c.top)}if(a)d=Math.sqrt((2*c.width**2+c.height**2)/3),d%2==0&&(d+=1);else{let e=Math.max(Math.abs((s?s.clientWidth:0)-l),l)*2+2,t=Math.max(Math.abs((s?s.clientHeight:0)-u),u)*2+2;d=Math.sqrt(e**2+t**2)}e?.touches?h.current===null&&(h.current=()=>{_({pulsate:i,rippleX:l,rippleY:u,rippleSize:d,cb:r})},p.start(80,()=>{h.current&&=(h.current(),null)})):_({pulsate:i,rippleX:l,rippleY:u,rippleSize:d,cb:r})},[n,_,p]),y=b.useCallback(()=>{v({},{pulsate:!0})},[v]),x=b.useCallback((e,t)=>{if(p.clear(),e?.type===`touchend`&&h.current){h.current(),h.current=null,p.start(0,()=>{x(e,t)});return}h.current=null,s(e=>e.length>0?e.slice(1):e),d.current=t},[p]);return b.useImperativeHandle(t,()=>({pulsate:y,start:v,stop:x}),[y,v,x]),(0,N.jsx)(B,{className:u(F.root,r.root,i),ref:g,...a,children:(0,N.jsx)(O,{component:null,exit:!0,children:o})})});function H(e){return l(`MuiButtonBase`,e)}var U=a(`MuiButtonBase`,[`root`,`disabled`,`focusVisible`]),re=e=>{let{disabled:t,focusVisible:n,focusVisibleClassName:r,suppressFocusVisible:i,classes:a}=e,o=s({root:[`root`,t&&`disabled`,n&&!i&&`focusVisible`]},H,a);return n&&!i&&r&&(o.root+=` ${r}`),o},ie=o(`button`,{name:`MuiButtonBase`,slot:`Root`})({display:`inline-flex`,alignItems:`center`,justifyContent:`center`,position:`relative`,boxSizing:`border-box`,WebkitTapHighlightColor:`transparent`,backgroundColor:`transparent`,outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:`pointer`,userSelect:`none`,verticalAlign:`middle`,MozAppearance:`none`,WebkitAppearance:`none`,textDecoration:`none`,color:`inherit`,"&::-moz-focus-inner":{borderStyle:`none`},[`&.${U.disabled}`]:{pointerEvents:`none`,cursor:`default`},"@media print":{colorAdjust:`exact`}}),W=b.forwardRef(function(e,t){let n=c({props:e,name:`MuiButtonBase`}),{action:r,centerRipple:i=!1,children:a,className:o,component:s=`button`,disabled:l=!1,disableRipple:d=!1,disableTouchRipple:p=!1,focusRipple:m=!1,focusVisibleClassName:h,focusableWhenDisabled:g,suppressFocusVisible:y=!1,internalNativeButton:x,LinkComponent:S=`a`,nativeButton:C,onBlur:w,onClick:T,onContextMenu:E,onDragLeave:D,onFocus:O,onFocusVisible:k,onKeyDown:A,onKeyUp:j,onMouseDown:M,onMouseLeave:P,onMouseUp:F,onTouchEnd:I,onTouchMove:L,onTouchStart:R,tabIndex:z=0,TouchRippleProps:B,touchRippleRef:V,type:H,...U}=n,W=!!(U.href||U.to),ae=!!U.formAction,K=s;K===`button`&&W&&(K=S);let q=typeof K==`string`?K===`button`:x??!1,oe=C??q,J=te(),se=_(J.ref,V),[Y,X]=b.useState(!1);(l||y)&&Y&&X(!1);let ce=f(e=>{m&&!e.repeat&&Y&&e.key===` `&&J.stop(e,()=>{J.start(e)})}),le=f(e=>{m&&e.key===` `&&Y&&!e.defaultPrevented&&J.stop(e,()=>{J.pulsate(e)})}),{getButtonProps:ue,rootRef:Z}=ee({nativeButton:oe,nativeButtonProp:C,internalNativeButton:q,allowInferredHostMismatch:W||typeof K==`string`,disabled:l,type:H,hasFormAction:ae,tabIndex:z,onBeforeKeyDown:ce,onBeforeKeyUp:le}),{onClick:de,onKeyDown:fe,onKeyUp:pe,...me}=ue({onClick:T,onKeyDown:A,onKeyUp:j});b.useImperativeHandle(r,()=>({focusVisible:()=>{X(!0),Z.current.focus()}}),[Z]);let he=J.shouldMount&&!d&&!l;b.useEffect(()=>{Y&&m&&!d&&J.pulsate()},[d,m,Y,J]);let ge=G(J,`start`,M,p),_e=G(J,`stop`,E,p),ve=G(J,`stop`,D,p),ye=G(J,`stop`,F,p),be=G(J,`stop`,e=>{Y&&e.preventDefault(),P&&P(e)},p),xe=G(J,`start`,R,p),Se=G(J,`stop`,I,p),Ce=G(J,`stop`,L,p),we=G(J,`stop`,e=>{v(e.target)||X(!1),w&&w(e)},!1),Te=f(e=>{Z.current||=e.currentTarget,!y&&v(e.target)&&(X(!0),k&&k(e)),O&&O(e)}),Q={};W&&(Q.tabIndex=l?-1:z,l&&(Q[`aria-disabled`]=l),Q.type=H);let Ee=_(t,Z),$={...n,centerRipple:i,component:s,disabled:l,disableRipple:d,disableTouchRipple:p,focusRipple:m,suppressFocusVisible:y,tabIndex:z,focusVisible:Y},De=re($);return(0,N.jsxs)(ie,{as:K,className:u(De.root,o),ownerState:$,onBlur:we,onClick:de,onContextMenu:_e,onFocus:Te,onKeyDown:fe,onKeyUp:pe,onMouseDown:ge,onMouseLeave:be,onMouseUp:ye,onDragLeave:ve,onTouchEnd:Se,onTouchMove:Ce,onTouchStart:xe,ref:Ee,...W?Q:me,...U,children:[a,he?(0,N.jsx)(ne,{ref:se,center:i,...B}):null]})});function G(e,t,n,r=!1){return f(i=>(n&&n(i),r||e[t](i),!0))}export{W as t};